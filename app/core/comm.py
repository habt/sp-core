...
import logging
import os
from app.library.settings import REQUESTS_TIMEOUT
...
class ServicePlannerComm():
    ...
    def request_gpu_update(self):
        ...
        try:
            # TODO: change to non-blocking requests
            ...
            logging.warning("Timeout fetching GPU predictions from %s", self.gpu_data_url)
            return None
    ...
    def request_net_update(self):
        ...
        try:
            ...
            logging.warning("Timeout fetching network predictions from %s", self.net_data_url)
            return None
    ...
    async def receive_recommendation_request(self):
        ...
        data = json.loads(msg)
        logging.info("Received recommendation request: %s", data)
